...
The hierarchical search with resampling method is done by `multiFixationSites` function. The function outputs a list of mutations with the sequence names involved before and after the fixation. The hiearchy search without resampling is `fixationSites`.
